...
switch (ciclo) {
    ...
    case 'turismo':
        document.getElementById('niveles').innerHTML =
            '<button type="button" class="btn btn-primary btn-sm">Modo Fácil turismo</button></a>' +
            '<button type="button" class="btn btn-primary btn-sm">Modo Difícil turismo</button>';
        break;
    case 'comunicion':
        document.getElementById('niveles').innerHTML =
            '<button type="button" class="btn btn-primary btn-sm">Modo Fácil comunicacion</button></a>' +
            '<button type="button" class="btn btn-primary btn-sm">Modo Difícil comunicacion</button>';
        break;
    case 'gestion':
        document.getElementById('niveles').innerHTML =
            '<button type="button" class="btn btn-primary btn-sm">Modo Fácil gestion</button></a>' +
